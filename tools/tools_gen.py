...
base_template = f"""<!-- DO NOT EDIT THIS FILE
It is automatically generated from index.template.html using tools_gen.py
Last modified: {datetime.datetime.now().isoformat()}
-->
"""
template = base_template + open("index.template.html").read()
